$(function (){
     ...
     */
    sendGetRequest("AccountService/ListAll", function (accounts) {
    ...
    $entities.delegate('.remove', 'click', function(){
        ...
        sendDeleteRequest("AccountService/Delete/" + id, function(Response){
    ...
    $entities.delegate('.saveEdit', 'click', function(){
        ...
        var updateUrl = "AccountService/UpdateItem/" + id;
